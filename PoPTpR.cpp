...
char szAppName[] = "PopPad" ; // שם מופע החלון - אב
char szCAppName[] = "Typer" ; // שם מופע החלון - בן

LRESULT CALLBACK WndProc (HWND, UINT, WPARAM, LPARAM) ; // PROC - אב
LRESULT CALLBACK CWndProc (HWND, UINT, WPARAM, LPARAM); // PROC - בן
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, "PopPad with Typer , זאב & חנן",
                          WS_OVERLAPPEDWINDOW,
